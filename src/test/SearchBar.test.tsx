...
const mockUseParams = jest.fn(() => { query: "somethingFromParams" });
...
describe("SearchBar component", () => {
    ...
    it("Should NOT replace URL on click, with shouldTrigger on false", () => {
        render(<SearchBar onSearch={mockOnSearch} shouldTriggerSearch={false} replaceOnSearch={true} />);
    ...
    it("Should not trigger field if the query is empty", () => {
        render(<SearchBar onSearch={mockOnSearch} shouldTriggerSearch={true} replaceOnSearch={true} />);
        ...
        act(() => {
            ReactDOM.render((
                <QuerySearchContext.Provider value={["something", jest.fn()]}>
                    <SearchBar onSearch={mockOnSearch} shouldTriggerSearch={false} replaceOnSearch={true} />
